...
const EditProfile = () => {
  ...
  return (
    <div className='flex justify-center px-4 sm:px-6'>
      <section className='flex flex-col gap-6 w-full max-w-lg py-8'>
        <h1 className='text-2xl font-semibold text-foreground'>Edit Profile</h1>

        {/* Profile Photo */}
        <div className='flex flex-col sm:flex-row items-center sm:justify-between bg-muted rounded-xl px-4 py-4 gap-4'>
          <div className='flex items-center gap-4'>
            ...
            <div className='flex flex-col'>
              ...
              <p className='text-xs text-muted-foreground'>{user?.bio || 'No bio available'}</p>
            </div>
          </div>
        ...
        <div className='space-y-2'>
          ...
          <Textarea
            ...
            value={input.bio}
            onChange={(e) => setInput({ ...input, bio: e.target.value })}
            className="text-sm focus-visible:ring-ring"
          />
        </div>
        ...
        <div className='flex justify-end'>
          {loading ? (
            <Button className='flex items-center gap-2 bg-primary hover:bg-primary/90 text-white px-6 py-2 text-sm'>
